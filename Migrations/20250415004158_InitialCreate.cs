        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedTheme = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotFoundErrors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NotFoundErrors_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Physical fitness and exercise goals", "Fitness" },
                    { 2, null, "Educational and skill development goals", "Learning" },
                    { 3, null, "Professional development and career goals", "Career" },
                    { 4, null, "Self-improvement and personal growth", "Personal Development" },
                    { 5, null, "Health and wellness goals", "Health" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotFoundErrors_UserId",
                table: "NotFoundErrors",
                column: "UserId");
